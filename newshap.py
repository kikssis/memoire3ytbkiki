...
# Version légère pour éviter les erreurs mémoire
# ============================================================
...
# ============================================================
# 8. MODÈLE XGBOOST LÉGER POUR SHAP
# ============================================================
# Ce modèle utilise la même cible et les mêmes variables que le modèle 8.2,
# mais il est volontairement plus léger pour permettre le calcul SHAP.
...
# Baseline Top-1 : toujours prédire la catégorie la plus fréquente du train
...
# Baseline Top-3 et Top-5 : toujours proposer les catégories les plus fréquentes du train
...
# Pour alléger le calcul SHAP, on utilise un échantillon du test set.
...
plt.tight_layout()
plt.savefig("shap_summary_global_xgboost_light.png", dpi=300, bbox_inches="tight")
plt.close()
...
# ============================================================
# 14. IMPORTANCE GLOBALE DES VARIABLES SHAP
# ============================================================
...
# ============================================================
# 16. GRAPHIQUES SHAP PAR CLASSE IMPORTANTE
# ============================================================
...
# ============================================================
# 17. SAUVEGARDES DES PRÉDICTIONS ET MÉTRIQUES
# ============================================================
...
print("- shap_summary_[classe]_xgboost_light.png")
